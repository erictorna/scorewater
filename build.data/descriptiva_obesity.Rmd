...
# High prevalence -> Obesity
```{r}
data = conditions_gral[condicio == 'Obesity', keyby=.(scensal, provincia, condicio, stand.)]
...
ggplot() + 
  ...
  ggtitle('10 regions with highest prevalence of Obesity') +
  labs(x = 'Censal code', y = 'Prevalence')
```

## Only Girona

* Censal unit with highest prevalence = area 'Font de la polvora'
...
ggplot() + 
  ...
  theme_minimal() +
  theme(axis.text.x = element_text(angle=45, hjust = 1)) +
  ggtitle('10 regions with lowest prevalence of Obesity') +
...
* Censal unit with lowest prevalence = area 'Plaça Catalunya'
```{r}
data1 = data[provincia == 'girona', keyby=.(scensal, provincia, condicio, stand.)]

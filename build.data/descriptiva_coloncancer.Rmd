...
# High prevalence -> Colon cancer
```{r}
data = conditions_gral[condicio == 'Colon cancer', keyby=.(scensal, provincia, condicio, stand.)]
...
ggplot() + 
  ...
  ggtitle('10 regions with highest prevalence of Colon cancer') +
...
ggplot() + 
  ...
  theme_minimal() +
  theme(axis.text.x = element_text(angle=45, hjust = 1)) +
  ggtitle('10 regions with lowest prevalence of Colon cancer') +
  labs(x = 'Censal code', y = 'Prevalence')
```
